...
import static com.example.login_ui.util.Action.DeleteFriendListReq;
...
public class FriendListAdapter extends SimpleAdapter {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        final Button deleteFriendBtn = (Button) view.findViewById(R.id.deleteFriendBtn);
        deleteFriendBtn.setTag(i);//设置标签        从零开始
        deleteFriendBtn.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            String msgstr = ProcessString.addstr(DeleteFriendListReq,String.valueOf(userBeanList.get(i).getId()));
